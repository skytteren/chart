...
object PlotChartInfo:
  implicit def stringNumberNumberPlotChartInfo[A: Numeric, B: Numeric]: PlotChartInfo[(String, Seq[(A, B)])] = new PlotChartInfo[(String, Seq[(A, B)])]{
  ...
  implicit def listStringNumberNumberPlotChartInfo[A: Numeric, B: Numeric]: PlotChartInfo[Seq[(String, Seq[(A, B)])]] = new PlotChartInfo[Seq[(String, Seq[(A, B)])]]{
